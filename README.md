...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/hsfish/gosnmp)](https://pkg.go.dev/github.com/hsfish/gosnmp)
...
[gosnmp/gosnmp](https://github.com/hsfish/gosnmp).
...
```shell
go get github.com/hsfish/gosnmp
```

# Documentation

https://pkg.go.dev/github.com/hsfish/gosnmp
...
1. [fork this repo on the GitHub webpage](https://github.com/hsfish/gosnmp/fork)
1. `go get github.com/hsfish/gosnmp`
1. `cd $GOPATH/src/github.com/hsfish/gosnmp`
...
Please create an [issue](https://github.com/hsfish/gosnmp/issues) on
...
gocov test github.com/hsfish/gosnmp | gocov-html > gosnmp.html && firefox gosnmp.html &
```
